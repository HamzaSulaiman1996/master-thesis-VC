...
_CUSTOM_TRANSFORM_RANDAUG_MAX_PARAMS = {
    "AdjustBrightness": (1, 0.9),
    "AdjustContrast": (1, 0.9),
    "AdjustSaturation": (1, 0.9),
    "AdjustSharpness": (1, 0.9),
...
class RandAugment:
    ...
    def __init__(
        ...
        Args:
            ...
            no_geometric (bool): True: no geometric transformations, False: apply geometric transformations
        ...
        aug_params = _CUSTOM_TRANSFORM_RANDAUG_MAX_PARAMS if no_geometric else _TRANSFORM_RANDAUG_MAX_PARAMS
        ...
        randaug_fn = [
            AugmentTransform(
                ...
                magnitude,
                prob=prob,
                transform_max_paras=aug_params,
                transform_hparas=transform_hparas,
                sampling_type=sampling_type,
                sampling_hparas=sampling_hparas,
            )
            for transform_name in list(aug_params.keys())
        ]
